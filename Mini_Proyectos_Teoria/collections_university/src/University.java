...
public class University {
    ...
    public void registerStudentToCourse(Integer idStudent, Integer idCourse) {
        try {
            ...
            if (studentFound == null) throw new StudentNotFoundException("El id de estudiante no es válido");
            Course courseFound = findCourseById(idCourse);
            if (courseFound == null) throw new CourseNotFoundException("El id del curso no es válido");
